...
TEST(eof_validation, EOF1_section_order)
{
    ...
    // 03 01 02 04
    EXPECT_EQ(validate_eof("EF0001 0300010014 010004 0200010006 040002 00 "
                           "EF000101000402000100010400000000800000FE 00800001 6000E0000000 AABB"),
        EOFValidationError::type_section_missing);

    // 01 03 02 04
    EXPECT_EQ(validate_eof("EF0001 010004 0300010014 0200010006 040002 00 00800001 "
                           "EF000101000402000100010400000000800000FE 6000E0000000 AABB"),
        EOFValidationError::code_section_missing);

    // 01 02 04 03
    EXPECT_EQ(validate_eof("EF0001 010004 0200010006 040002 0300010014 00 00800001 6000E0000000 "
...
{
    EXPECT_EQ(validate_eof("EF0001 010004 0200010001 040000 00 00800000 D1"),
        EOFValidationError::truncated_instruction);

    EXPECT_EQ(validate_eof("EF0001 010004 0200010002 040000 00 00800000 D100"),
        EOFValidationError::truncated_instruction);
}
...
{
    // DATALOADN{0}
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040020 00 00800001 D100005000"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::success);

    // DATALOADN{1}
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040021 00 00800001 D100015000"
                           "000000000000000011111111111111112222222222222222333333333333333344"),
        EOFValidationError::success);

    // DATALOADN{32}
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040040 00 00800001 D100205000"
                           "0000000000000000111111111111111122222222222222223333333333333333"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::success);

    // DATALOADN{0} - no data section
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040000 00 00800001 D100005000"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{1} - out of data section bounds
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040001 00 00800001 D100015000"
                           "00"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{32} - out of data section bounds
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040020 00 00800001 D100205000"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{uint16_max} - out of data section bounds
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 040020 00 00800001 D1ffff5000"
                           "0000000000000000111111111111111122222222222222223333333333333333"),
        EOFValidationError::invalid_dataloadn_index);

    // DATALOADN{32} - truncated word
    EXPECT_EQ(validate_eof("EF0001 010004 0200010005 04003F 00 00800001 D100205000"
                           "0000000000000000111111111111111122222222222222223333333333333333"
...
TEST(eof_validation, EOF1_create3_invalid)
{
    ...
    cont = eof_bytecode(bytecode(0) + 0xff + 0 + 0 + OP_CREATE3 + Opcode{0} + OP_POP + OP_STOP, 4)
               .container(embedded_truncated_data);
    EXPECT_EQ(
        validate_eof(cont, EVMC_PRAGUE), EOFValidationError::create3_with_truncated_container);
}
