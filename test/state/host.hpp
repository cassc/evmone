...
/// Computes the address of to-be-created contract with the CREATE3 scheme.
///
/// Computes the new account address for the contract creation context of the CREATE3 instruction.
///
/// @param sender        The address of the message sender.
/// @param salt          The salt.
/// @param initcontainer The contract creation init container.
/// @return              The address computed with the CREATE3 scheme.
[[nodiscard]] address compute_create3_address(
