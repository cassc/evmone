...
struct BaseFieldConfig
{
    ...
    static const ModArith<ValueT> MOD_ARITH;
    // 1 in Montgomery form
    static constexpr uint256 ONE =
        0xe0a77c19a07df2f666ea36f7879462c0a78eb28f5c70b3dd35d438dc58f0d9d_u256;
};
const ModArith<BaseFieldConfig::ValueT> BaseFieldConfig::MOD_ARITH = ModArith(FieldPrime);
...
static inline Fq2 make_fq2(std::array<uint256, 2> a) noexcept
{
    return Fq2({Fq(a[0]).to_mont(), Fq(a[1]).to_mont()});
}

[[maybe_unused]] inline constexpr Fq6 make_fq6(
